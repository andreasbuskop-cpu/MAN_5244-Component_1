...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are a helpful navigation assistant for the Drift AI website. Your role is to help users navigate the website and understand the content.
...
1. Guide them to the relevant section by suggesting they scroll or click navigation links
2. Provide brief summaries of the section content
3. Be friendly, concise, and helpful
4. If they ask about something not on the website, politely let them know and suggest related content that is available
